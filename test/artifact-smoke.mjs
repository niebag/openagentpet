...
try {
  ...
  assert.deepEqual(await packageFiles(packageDirectory), [
    ...
    "package.json",
    "public/default-pet-pack/README.md",
    "public/default-pet-pack/idle.gif",
    "public/default-pet-pack/manifest.json",
    "public/default-pet-pack/needs-input.gif",
    "public/default-pet-pack/researching.gif",
    "public/default-pet-pack/thinking.gif",
    "public/default-pet-pack/working.gif",
    "public/pet.html",
    "public/pet.js",
  ]);
